  ...
  const handleLogin = () => {
    axios.post("http://localhost:8000/api/v1/user/login", { "email": Email, "password": Password })
      .then(async (res) => {
        ...
        await UpdateUserData(res.data.data.accessToken ,res.data.data.user);
        displayAccessToken();
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 ">
        ...
        <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            ...
            <form action="#" method="POST" className="mt-8 w-100">
              <div className="space-y-5">
                ...
                <div>
                  <button
                    type="button"
                    className=" login-btn inline-flex w-full items-center justify-center rounded-md bg-black px-3.5 py-2.5 font-semibold leading-7 text-white hover:bg-black/80 "
                    onClick={handleLogin}
                  >
                    Login
                  </button>
